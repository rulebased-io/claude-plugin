---
name: project-collab
description: 프로젝트 협업자에게 특정 프로젝트 범위를 공유하는 Permission Set
type: permission-set
---
...
| 경로 | 권한 | 용도 |
|------|------|------|
| `workspace/projects/{project-name}/` | 읽기+쓰기 | 프로젝트 협업 |
...
이 세션에서 에이전트는 **캡처 & 정리 Agent** + **코드 개발 보조 Agent** 역할을 조합한다.
- 프로젝트 관련 콘텐츠 작성 및 구조화
- 코드 스니펫 저장 및 정리
- 소유자 확인 후에만 파일 이동
