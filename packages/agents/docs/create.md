...
Creates a Markdown file at `.rulebased/agents/delegates/{name}.md` that describes an agent this project exposes to other projects for cross-repo communication.
